        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          ...
          <div className="grid sm:grid-cols-3 gap-4 sm:gap-6 mb-10">
            <div className="rounded-2xl bg-white border border-white/80 p-4 flex items-center gap-3 text-blue-800">
              ...
              <div>
                ...
                <div className="text-sm font-semibold text-blue-900">XX June 2026</div>
              </div>
            </div>
            <div className="rounded-2xl bg-white border border-white/80 p-4 flex items-center gap-3 text-blue-800">
              ...
              <div>
                ...
                <div className="text-sm font-semibold text-blue-900">7am to 5pm</div>
              </div>
            </div>
            <div className="rounded-2xl bg-white border border-white/80 p-4 flex items-center gap-3 text-blue-800">
          ...
          <div className="bg-white/10 border border-white/20 rounded-2xl p-6 backdrop-blur">
            ...
            <ul className="list-disc list-inside text-blue-100 text-sm space-y-1">
              ...
              <li>Bonding & Live Entertainment</li>
            ...
            <div className="mt-5 flex flex-col sm:flex-row gap-3">
                          <Link href="/events2027" className="rounded-lg bg-white text-blue-700 font-semibold px-5 py-2 shadow hover:shadow-md transition text-sm text-center">
                Browse Past Events
              </Link>
