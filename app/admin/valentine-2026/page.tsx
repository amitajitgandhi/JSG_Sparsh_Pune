              ...
              <table className='min-w-full divide-y divide-gray-200'>
                <thead className='bg-gray-50'>
                  <tr>
                    ...
                    <th className='px-4 py-2 text-xs font-semibold text-gray-600'>Mobile</th>
                    <th className='px-4 py-2 text-xs font-semibold text-gray-600'>Confirmed</th>
                    <th className='px-4 py-2 text-xs font-semibold text-gray-600'>Submitted At</th>
                  </tr>
                </thead>
